...
var format_TempatBersejarah_3 = new ol.format.GeoJSON();
var features_TempatBersejarah_3 = format_TempatBersejarah_3.readFeatures(json_TempatBersejarah_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TempatBersejarah_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TempatBersejarah_3.addFeatures(features_TempatBersejarah_3);
var lyr_TempatBersejarah_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_TempatBersejarah_3, 
                style: style_TempatBersejarah_3,
                interactive: true,
                title: '<img src="styles/legend/TempatBersejarah_3.png" /> Tempat Bersejarah'
            });

lyr_googleearth_0.setVisible(true);lyr_mukim_mlk_1.setVisible(true);lyr_district_mlk_2.setVisible(true);lyr_TempatBersejarah_3.setVisible(true);
var layersList = [lyr_googleearth_0,lyr_mukim_mlk_1,lyr_district_mlk_2,lyr_TempatBersejarah_3];
...
lyr_TempatBersejarah_3.set('fieldAliases', {'qc_id': 'qc_id', 'image': 'image', 'name': 'name', 'latitude': 'latitude', 'longitud': 'longitud', 'build on': 'build on', 'background': 'background', 'address': 'address', 'opened on': 'opened on', 'time': 'time', 'ticket': 'ticket', 'link gmap': 'link gmap', '360': '360', });
...
lyr_TempatBersejarah_3.set('fieldImages', {'qc_id': 'TextEdit', 'image': 'ExternalResource', 'name': 'TextEdit', 'latitude': 'TextEdit', 'longitud': 'TextEdit', 'build on': 'TextEdit', 'background': 'TextEdit', 'address': 'TextEdit', 'opened on': 'TextEdit', 'time': 'TextEdit', 'ticket': 'TextEdit', 'link gmap': 'TextEdit', '360': 'TextEdit', });
...
lyr_TempatBersejarah_3.set('fieldLabels', {'qc_id': 'header label', 'image': 'header label', 'name': 'header label', 'latitude': 'header label', 'longitud': 'header label', 'build on': 'header label', 'background': 'header label', 'address': 'header label', 'opened on': 'header label', 'time': 'header label', 'ticket': 'header label', 'link gmap': 'header label', '360': 'header label', });
lyr_TempatBersejarah_3.on('precompose', function(evt) {
